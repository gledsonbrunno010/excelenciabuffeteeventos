...
const WhatsAppFloating: React.FC = () => {
    return (
        ...
        >
            ...
            {/* Tooltip on hover */}
            <span className="absolute right-full mr-4 bg-white text-[#1c090b] px-4 py-2 rounded-lg text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-xl">
                WhatsApp
            </span>
        </a>
    );
