          ...
          <div className="flex flex-col items-center text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-8 pt-8 w-full sm:w-auto">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border border-[#fcfdff]/30 text-[#fcfdff] px-8 py-4 md:px-16 md:py-8 text-sm md:text-lg font-bold uppercase tracking-[0.3em] transition-all hover:bg-white/10 flex items-center justify-center"
              >
                Conhecer Instagram
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-8 border-b border-[#1c090b]/10 pb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 pt-4">
                <a href="https://www.instagram.com/excelenciabuffeteeventos/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 border border-[#1c090b]/10 rounded-full flex items-center justify-center hover:bg-[#1c090b] hover:text-white transition-all">
