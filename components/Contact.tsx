...
const Contact: React.FC = () => {
  return (
    <footer className="relative overflow-hidden">
      {/* Final CTA Section */}
      <div className="bg-[#1c090b] text-[#fcfdff] py-16 md:py-32 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col items-center text-center space-y-12">
            <span className="text-xs font-bold tracking-[0.6em] uppercase opacity-40">Agenda {new Date().getFullYear() + 1}</span>
            ...
            <div className="flex flex-col sm:flex-row gap-8 pt-8 w-full sm:w-auto">
              <a
                ...
                className="bg-[#fcfdff] text-[#1c090b] px-8 py-4 md:px-16 md:py-8 text-sm md:text-lg font-bold uppercase tracking-[0.3em] transition-all hover:bg-[#fce4be] hover:scale-105 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-center"
              >
                Falar no WhatsApp
              </a>
              <a
                href="https://www.instagram.com/excelenciabuffeteeventos/"
                target="_blank"
                rel="noopener noreferrer"
                className="border border-[#fcfdff]/30 text-[#fcfdff] px-8 py-4 md:px-16 md:py-8 text-sm md:text-lg font-bold uppercase tracking-[0.3em] transition-all hover:bg-gradient-to-r hover:from-[#833ab4] hover:via-[#fd1d1d] hover:to-[#fcb045] hover:border-transparent flex items-center justify-center"
              >
                Conhecer Instagram
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-8 border-b border-[#1c090b]/10 pb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 pt-4">
                <a href="https://www.instagram.com/excelenciabuffeteeventos/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 border border-[#1c090b]/10 rounded-full flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#833ab4] hover:via-[#fd1d1d] hover:to-[#fcb045] hover:text-white hover:border-transparent transition-all text-[#1c090b]">
                ...
                <a href="#" className="w-12 h-12 border border-[#1c090b]/10 rounded-full flex items-center justify-center hover:bg-[#1877F2] hover:text-white hover:border-transparent transition-all text-[#1c090b]">
                  <span className="sr-only">Facebook</span>
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-8.778h-2.954v-3.424h2.954v-2.527c0-2.924 1.786-4.516 4.394-4.516 1.25 0 2.324.093 2.637.135v3.057l-1.808.001c-1.419 0-1.694.675-1.694 1.664v2.186h3.384l-.44 3.424h-2.944v8.778h6.108c.731 0 1.324-.593 1.324-1.324v-21.351c0-.732-.593-1.325-1.325-1.325z" /></svg>
                </a>
              </div>
            </div>
          </div>
