          ...
          <div className="flex flex-col items-center text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-8 pt-8 w-full sm:w-auto">
              <a
                ...
                className="bg-[#fce4be] text-[#1c090b] px-8 py-4 md:px-16 md:py-8 text-sm md:text-lg font-bold uppercase tracking-[0.3em] transition-all hover:bg-[#fcfdff] hover:scale-105 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-center"
              >
                Falar no WhatsApp
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-[#fcfdff] px-8 py-4 md:px-16 md:py-8 text-sm md:text-lg font-bold uppercase tracking-[0.3em] transition-all hover:scale-105 flex items-center justify-center border-0"
              >
                Conhecer Instagram
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-8 border-b border-[#1c090b]/10 pb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 pt-4">
                <a href="https://www.instagram.com/excelenciabuffeteeventos/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white transition-all transform hover:scale-110">
                ...
                <a href="#" className="w-12 h-12 rounded-full flex items-center justify-center bg-[#1877F2] text-white transition-all transform hover:scale-110">
